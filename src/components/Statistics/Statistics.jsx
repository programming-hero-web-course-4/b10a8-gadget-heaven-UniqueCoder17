...
const Statistics = () => {
    return (
        <div>
            ...
            <h1 className='text-2xl font-bold pt-5 pl-5'>Statistics</h1>
            <h1 className="text-2xl lg:text-4xl font-bold text-center text-[#9538E2] py-5">There are no data to display statistics</h1>
