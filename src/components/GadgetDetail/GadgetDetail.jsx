...
const GadgetDetail = () => {
    ...
    const { product_id: currentProduct_id, product_image, product_title, price, description, Specification, rating } = gadget;
                ...
                <div className="relative mt-5">
                    <div className='flex flex-col lg:flex-row w-[300px] bg-white lg:w-[820px] border-2 mx-auto mb-10 p-4 rounded-3xl'>
                        ...
                        <div className='space-y-2 mt-4 lg:mt-0'>
                            ...
                            <div className='flex'>
                                <button className='flex mr-4 text-white bg-[#9538E2] py-1 px-2 rounded-2xl font-bold'>Add To Card <TiShoppingCart className="w-8 h-6 text-white" /></button>
                                <button><FaRegHeart className="w-6 h-6 text-gray-600 ml-1" /></button>
                            </div>
                        </div>
                    </div>
                </div>
